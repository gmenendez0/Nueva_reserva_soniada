...
public:
    ...
    void rescatar_animal(Arbol_B<Animal*> &registro_de_animales, int &combustible_auto);
...
private:
    ...
    string realizar_rescate(int combustible_necesitado, Animal* animal_a_rescatar, Arbol_B<Animal*> &registro_de_animales, int &combustible_auto);
    ...
    void desplegar_menu_error(Arbol_B <Animal*> &registro_de_animales, int &combustible_auto);
    ...
    void leer_archivo_vertices(Grafo &grafo_mapa, Animal* animales_a_rescatar[]);
