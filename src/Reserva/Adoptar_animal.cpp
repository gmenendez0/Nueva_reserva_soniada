...
void Adoptar_animal::pedir_animal(Arbol_B<Animal*> &registro_de_animales, int espacio_disponible){
    string respuesta;
...
void Adoptar_animal::adoptar_animal(Arbol_B<Animal*> &registro_de_animales){
