...
void Buscar_animal::comprobar_animal_buscado(string &nombre, Arbol_B<Animal*> &registro_de_animales, Animal* &animal_buscado){
...
Animal* Buscar_animal::ingresar_nombre(Arbol_B<Animal*> &registro_de_animales){
    string nombre;
...
void Buscar_animal::proceso_de_busqueda(Arbol_B<Animal*> &registro_de_animales){
