...
public:
    ...
    void cuidar_animales(Arbol_B<Animal*> &registro_de_animales);

private:
    //Pre Debe recibir el arbol de animales
    //Post Pone en marchas las debidas funciones para aplicar cuidados individuales a un animal
    void elegir_animal(Arbol_B<Animal*> &registro_de_animales);
    ...
    Animal* pedir_nombre(Arbol_B<Animal*> &registro_de_animales);
