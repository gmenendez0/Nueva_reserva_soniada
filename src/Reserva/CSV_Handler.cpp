...
#include "Animal/Conejo.h"
#include "Animal/Caballo.h"
#include "Animal/Lagartija.h"
#include "Animal/Perro.h"
#include "Animal/Roedor.h"
...
void CSV_Handler::crear_animal(string nombre, int edad, string tamanio, char especie, string personalidad, Arbol_B<Animal*> &registro_de_animales){
...
void CSV_Handler::revisar_especie(string nombre, int edad, string tamanio, char especie, string personalidad, Arbol_B<Animal*> &registro_de_animales){
...
void CSV_Handler::inicializar_registro(std::ifstream &archivo_animales, Arbol_B<Animal*> &registro_de_animales){
    string especie;
    string edad;
    string nombre;
    string personalidad;
...
int CSV_Handler::abrir_archivo(Arbol_B<Animal*> &registro_de_animales){
