...
Animal* Cuidar_animales::pedir_nombre(ArbolB<Animal*> &registro_de_animales){
    string nombre;
...
void Cuidar_animales::elegir_animal(ArbolB<Animal*> &registro_de_animales){
...
void Cuidar_animales::cuidar_animales(ArbolB<Animal*> &registro_de_animales){
