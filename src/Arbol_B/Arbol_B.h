...
class Arbol_B{
    ...
    private:
        ...
        //Setea los hijos de un nodo padre de dos datos.
...
template<typename Tipo_de_animal>
Arbol_B <Tipo_de_animal>::Arbol_B(){
    raiz = nullptr;
}

template<typename Tipo_de_animal>
int Arbol_B<Tipo_de_animal>::insertar(Tipo_de_animal animal){
...
template<typename Tipo_de_animal>
int* Arbol_B<Tipo_de_animal>::insertar_en_arbol(Tipo_de_animal animal, Nodo<Tipo_de_animal>* nodo_a_insertar, bool &animal_a_insertar_proviene_de_split, int* resultado_insercion){
...
template<typename Tipo_de_animal>
void Arbol_B <Tipo_de_animal>::evaluar_posibilidades_nodo_hoja(Tipo_de_animal animal, Nodo<Tipo_de_animal>* nodo_a_insertar, bool &animal_a_insertar_proviene_de_split, int*
resultado_insercion){
...
template<typename Tipo_de_animal>
void Arbol_B <Tipo_de_animal>::evaluar_posibilidades_nodo_con_hijos(Tipo_de_animal animal, Nodo <Tipo_de_animal>* nodo_a_insertar, bool &animal_a_insertar_proviene_de_split, int*
resultado_insercion){
...
template<typename Tipo_de_animal>
void Arbol_B <Tipo_de_animal>::realizar_insercion(Nodo <Tipo_de_animal>* nodo_a_insertar, Tipo_de_animal animal){
...
template<typename Tipo_de_animal>
void Arbol_B <Tipo_de_animal>::evaluar_insercion_proveniente_de_split(Nodo <Tipo_de_animal>* nodo_a_insertar, Tipo_de_animal animal, bool &animal_a_insertar_proviene_de_split, int*
resultado_insercion){
    if(nodo_a_insertar->get_tope_datos() == UN_DATO){
        realizar_insercion(nodo_a_insertar, animal);
    } else {
...
template<typename Tipo_de_animal>
void Arbol_B <Tipo_de_animal>::realizar_insercion_proveniente_de_split_nodo_lleno(Nodo <Tipo_de_animal>* nodo_a_insertar, Tipo_de_animal animal, bool &animal_a_insertar_proviene_de_split, int* resultado_insercion){
    if(animal_es_mas_grande(animal->get_nombre(), nodo_a_insertar)){
...
template<typename Tipo_de_animal>
void Arbol_B <Tipo_de_animal>::evaluar_insercion_no_proveniente_de_split_nodo_no_lleno(Nodo <Tipo_de_animal>* nodo_a_insertar, Tipo_de_animal animal, bool &animal_a_insertar_proviene_de_split, int* resultado_insercion){
    if(nodo_a_insertar->get_primera_clave() > animal->get_nombre()){
...
template<typename Tipo_de_animal>
void Arbol_B <Tipo_de_animal>::evaluar_insercion_no_proveniente_de_split_nodo_lleno(Nodo <Tipo_de_animal>* nodo_a_insertar, Tipo_de_animal animal, bool &animal_a_insertar_proviene_de_split,
                                                                                    int* resultado_insercion){
    if(animal_es_mas_grande(animal->get_nombre(), nodo_a_insertar)){
...
template<typename Tipo_de_animal>
void Arbol_B <Tipo_de_animal>::evaluar_insercion_no_proveniente_de_split(Nodo <Tipo_de_animal>* nodo_a_insertar, Tipo_de_animal animal, bool &animal_a_insertar_proviene_de_split,
                                                                         int* resultado_insercion){
    if(nodo_a_insertar->get_tope_datos() == UN_DATO){
...
template<typename Tipo_de_animal>
void Arbol_B <Tipo_de_animal>::split_hoja(Nodo<Tipo_de_animal>* nodo_a_splitear, Tipo_de_animal dato_menor, Tipo_de_animal dato_intermedio, Tipo_de_animal
dato_mayor, bool &animal_a_insertar_proviene_de_split, int* resultado_insercion){
...
template<typename Tipo_de_animal>
void Arbol_B <Tipo_de_animal>::realizar_split_nodo_hoja_raiz(Nodo<Tipo_de_animal>* nodo_a_splitear, Tipo_de_animal dato_menor, Tipo_de_animal dato_intermedio, Tipo_de_animal
dato_mayor){
...
template<typename Tipo_de_animal>
void Arbol_B <Tipo_de_animal>::realizar_split_nodo_hoja_no_lleno(Nodo <Tipo_de_animal>* nodo_a_splitear, Tipo_de_animal dato_menor, Tipo_de_animal dato_intermedio, Tipo_de_animal
dato_mayor, bool &animal_a_insertar_proviene_de_split, int* resultado_insercion){
...
template<typename Tipo_de_animal>
void Arbol_B <Tipo_de_animal>::realizar_split_nodo_hoja_lleno(Nodo <Tipo_de_animal>* nodo_a_splitear, Tipo_de_animal dato_menor, Tipo_de_animal dato_intermedio, Tipo_de_animal dato_mayor,
...
template<typename Tipo_de_animal>
void Arbol_B <Tipo_de_animal>::split_nodo_con_hijos(Nodo <Tipo_de_animal>* nodo_a_splitear, Tipo_de_animal dato_menor, Tipo_de_animal dato_intermedio,
...
template<typename Tipo_de_animal>
void Arbol_B <Tipo_de_animal>::setear_parentescos_nodo_spliteado(Nodo <Tipo_de_animal>* primer_nuevo_nodo, Nodo <Tipo_de_animal>* segundo_nuevo_nodo, Nodo <Tipo_de_animal>* nodo_a_splitear){
...
template<typename Tipo_de_animal>
void Arbol_B <Tipo_de_animal>::split_nodo_raiz_con_hijos(Nodo <Tipo_de_animal>* nodo_a_splitear, Tipo_de_animal dato_menor, Tipo_de_animal dato_intermedio, Tipo_de_animal dato_mayor){
    Nodo<Tipo_de_animal>* nodo_superior = new Nodo<Tipo_de_animal>(dato_intermedio);
    Nodo<Tipo_de_animal>* nodo_menor = new Nodo<Tipo_de_animal>(dato_menor, nullptr, nodo_superior);
    Nodo<Tipo_de_animal>* nodo_mayor = new Nodo<Tipo_de_animal>(dato_mayor, nullptr, nodo_superior);
...
template<typename Tipo_de_animal>
void Arbol_B <Tipo_de_animal>::split_nodo_con_hijos_no_raiz(Nodo <Tipo_de_animal>* nodo_a_splitear, Tipo_de_animal dato_menor, Tipo_de_animal dato_intermedio, Tipo_de_animal
dato_mayor, bool &animal_a_insertar_proviene_de_split, int* resultado_insercion){
    Nodo<Tipo_de_animal>* nodo_menor = new Nodo<Tipo_de_animal>(dato_menor, nullptr, nodo_a_splitear->get_nodo_padre());
    Nodo<Tipo_de_animal>* nodo_mayor = new Nodo<Tipo_de_animal>(dato_mayor, nullptr, nodo_a_splitear->get_nodo_padre());
...
template<typename Tipo_de_animal>
void Arbol_B <Tipo_de_animal>::ordenar_parentezco_padre_un_dato(Nodo <Tipo_de_animal>* nodo_a_splitear, Nodo <Tipo_de_animal>* nodo_menor, Nodo <Tipo_de_animal>* nodo_mayor){
...
template<typename Tipo_de_animal>
void Arbol_B <Tipo_de_animal>::setear_hijos_padre_dos_datos(Nodo <Tipo_de_animal>* nodo_padre, Nodo <Tipo_de_animal>* primer_hijo, Nodo <Tipo_de_animal>* segundo_hijo, Nodo <Tipo_de_animal>*
...
template<typename Tipo_de_animal>
void Arbol_B <Tipo_de_animal>::ordenar_parentezco_padre_dos_datos(Nodo <Tipo_de_animal>* nodo_a_splitear, Nodo <Tipo_de_animal>* nuevo_nodo_menor, Nodo <Tipo_de_animal>* nuevo_nodo_mayor){
    if(nodo_a_splitear->es_primer_hijo()){
...
template<typename Tipo_de_animal>
bool Arbol_B <Tipo_de_animal>::animal_es_mas_grande(string nombre_animal, Nodo <Tipo_de_animal>* nodo_a_insertar){
    return (nodo_a_insertar->get_primera_clave() < nombre_animal && nodo_a_insertar->get_segunda_clave() < nombre_animal);
}

template<typename Tipo_de_animal>
bool Arbol_B <Tipo_de_animal>::animal_es_intermedio(string nombre_animal, Nodo <Tipo_de_animal>* nodo_a_insertar){
    return (nodo_a_insertar->get_primera_clave() < nombre_animal && nodo_a_insertar->get_segunda_clave() > nombre_animal);
}

template<typename Tipo_de_animal>
Tipo_de_animal Arbol_B <Tipo_de_animal>::buscar_animal(string nombre){
    return revisar_arbol(nombre, raiz);
}

template<typename Tipo_de_animal>
Tipo_de_animal Arbol_B <Tipo_de_animal>::revisar_arbol(string nombre, Nodo <Tipo_de_animal>* nodo_a_revisar){
...
template<typename Tipo_de_animal>
Tipo_de_animal Arbol_B <Tipo_de_animal>::analizar_animal_encontrado(Tipo_de_animal animal_encontrado){
...
template<typename Tipo_de_animal>
int Arbol_B <Tipo_de_animal>::adoptar_animal(string nombre, int espacio_disponible){
...
template<typename Tipo_de_animal>
void Arbol_B <Tipo_de_animal>::presentar_todos(){
    this->presentar_todos(raiz);
}

template<typename Tipo_de_animal>
void Arbol_B <Tipo_de_animal>::presentar_todos(Nodo <Tipo_de_animal>* nodo_actual){
...
template<typename Tipo_de_animal>
void Arbol_B <Tipo_de_animal>::presentar_datos_nodo(Nodo <Tipo_de_animal>* nodo_actual){
...
template<typename Tipo_de_animal>
bool Arbol_B <Tipo_de_animal>::esta_vacio(){
    return (raiz == nullptr);
}

template<typename Tipo_de_animal>
void Arbol_B <Tipo_de_animal>::pasar_tiempo(int &combustible_auto){
...
template<typename Tipo_de_animal>
void Arbol_B <Tipo_de_animal>::pasar_tiempo_nodo(Nodo <Tipo_de_animal>* nodo_actual, int* animales_escapados){
    for(int i = 0; i < nodo_actual->get_tope_datos(); ++i){
...
template<typename Tipo_de_animal>
void Arbol_B <Tipo_de_animal>::pasar_tiempo(Nodo <Tipo_de_animal>* nodo_actual, int* animales_escapados){
...
template<typename Tipo_de_animal>
void Arbol_B <Tipo_de_animal>::desarmar_reserva(int* animales_escapados){
...
template<typename Tipo_de_animal>
void Arbol_B <Tipo_de_animal>::presentar_cuidables(){
    presentar_cuidables(raiz);
}

template<typename Tipo_de_animal>
void Arbol_B <Tipo_de_animal>::presentar_cuidables(Nodo <Tipo_de_animal>* nodo_actual){
...
template<typename Tipo_de_animal>
void Arbol_B <Tipo_de_animal>::presentar_cuidables_nodo(Nodo <Tipo_de_animal>* nodo_actual){
    for(int i = 0; i < nodo_actual->get_tope_datos(); ++i){
...
template<typename Tipo_de_animal>
bool Arbol_B <Tipo_de_animal>::animal_esta_presente(Tipo_de_animal animal){
    return (!animal->esta_eliminado() && !animal->se_escapo());
}

template<typename Tipo_de_animal>
void Arbol_B <Tipo_de_animal>::guardar_datos_en_archivo(){
...
template<typename Tipo_de_animal>
void Arbol_B <Tipo_de_animal>::chequear_archivo_escritura(std::ofstream &archivo_animales){
...
template<typename Tipo_de_animal>
void Arbol_B <Tipo_de_animal>::guardar_datos_en_archivo(Nodo <Tipo_de_animal>* nodo_actual, std::ofstream &archivo_animales){
...
template<typename Tipo_de_animal>
void Arbol_B <Tipo_de_animal>::realizar_guardado(Nodo <Tipo_de_animal>* nodo_actual, std::ofstream &archivo_animales){
    for(int i = 0; i < nodo_actual->get_tope_datos(); ++i){
...
template<typename Tipo_de_animal>
string Arbol_B <Tipo_de_animal>::recibir_datos_animal(Tipo_de_animal animal){
...
template<typename Tipo_de_animal>
void Arbol_B <Tipo_de_animal>::eliminar_todos(){
    eliminar_todos(raiz);
}

template<typename Tipo_de_animal>
void Arbol_B <Tipo_de_animal>::eliminar_todos(Nodo <Tipo_de_animal>* nodo_actual){
...
template<typename Tipo_de_animal>
void Arbol_B <Tipo_de_animal>::borrar_datos(Nodo <Tipo_de_animal>* nodo_actual){
    for(int i = 0; i < nodo_actual->get_tope_datos(); ++i){
...
template<typename Tipo_de_animal>
int Arbol_B <Tipo_de_animal>::mostrar_animales_adoptables(int espacio_disponible){
...
template<typename Tipo_de_animal>
void Arbol_B <Tipo_de_animal>::presentar_animales_adoptables(int espacio_disponible, int* cantidad_animales_adoptables, Nodo <Tipo_de_animal>* nodo_actual){
    for(int i = 0; i < nodo_actual->get_tope_datos(); ++i){
...
template<typename Tipo_de_animal>
int Arbol_B <Tipo_de_animal>::mostrar_animales_adoptables(int espacio_disponible, int* cantidad_animales_adoptables, Nodo <Tipo_de_animal>* nodo_actual){
